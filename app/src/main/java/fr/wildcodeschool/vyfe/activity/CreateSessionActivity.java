...
public class CreateSessionActivity extends VyfeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        radioButtonImport.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                KeyboardHelper.CloseKeyboard(CreateSessionActivity.this, radioButtonImport);
        ...
        radioButtonNew.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                KeyboardHelper.CloseKeyboard(CreateSessionActivity.this, radioButtonNew);
        ...
        buttonGo.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (radioButtonNew.isChecked() && titleTagSet.isEmpty()) {
                    Toast.makeText(CreateSessionActivity.this, R.string.choose_name_grid, Toast.LENGTH_LONG).show();
                } else {
                    if (mTagModelListAdd.isEmpty()) {
                        Toast.makeText(CreateSessionActivity.this, R.string.empty_grid, Toast.LENGTH_LONG).show();
                    } else {
                        ...
                        mTagsSetsList.add(new TagSetModel(idTagSet, titleTagSet));
                        ...
                        if ("multiSession".equals(multiSession)) {
                            ...
                            if (titleSession.isEmpty()) {
                                Toast.makeText(CreateSessionActivity.this, R.string.title, Toast.LENGTH_SHORT).show();
                            } else {
                                cleanSharedPref();
                                startActivity(intent);
    ...
    public void onPressAddTags() {
        ...
        Intent intent = new Intent(CreateSessionActivity.this, AddGridActivity.class);
        startActivity(intent);
    }
