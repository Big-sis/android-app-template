...
public class RecordPlayerFragment extends Fragment implements View.OnClickListener {
    ...
    public static RecordPlayerFragment newInstance() {
        return new RecordPlayerFragment();
    }
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        viewModel = ViewModelProviders.of((FragmentActivity) this.getActivity()).get(RecordVideoViewModel.class);
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        tvSpace = view.findViewById(R.id.tv_storage_space_left);
        ...
        stopwatch.setOnChronometerTickListener(new Chronometer.OnChronometerTickListener() {
            ...
            public void onChronometerTick(Chronometer chronometer) {
                viewModel.setVideoTime(((StopwatchView) chronometer).getTime());
            }
        });
        ...
        mRecordButton.setImageResource(R.drawable.icons8_appel_video_60);
    }
    ...
    private void setUpMediaRecorder(String videoAbsolutePath) throws IOException {
        final Activity activity = getActivity();
        if (null == activity) {
            return;
        }
        ...
        if (mNextVideoAbsolutePath == null || mNextVideoAbsolutePath.isEmpty()) {
            mNextVideoAbsolutePath = videoAbsolutePath;
        }
    ...
    private void startRecordingVideo(String videoAbsolutePath) {
        if (null == mCameraDevice || !mTextureView.isAvailable() || null == mPreviewSize) {
            return;
        }
        try {
            closePreviewSession();
            setUpMediaRecorder(videoAbsolutePath);
            SurfaceTexture texture = mTextureView.getSurfaceTexture();
            assert texture != null;
            texture.setDefaultBufferSize(mPreviewSize.getWidth(), mPreviewSize.getHeight());
